...
global.ownername = "ᴹᴿ᭄CASSE ×፝֟͜×" //nama kalian
global.myweb = "https://s.id/zeeoneofc" //bebas asal jan hapus
global.youtube = "https://youtube.com/@f.hytboy9280" //bebas asal jan hapus
global.myweb2 = "https://s.id/zeeoneofc" //bebas
global.email = "farukhoque9932@gmail.com@" //bebas
global.region = "INDIA" //bebas
global.timezone = 'ASIA/MUMBAI' //  timezone wib
...
global.badword_list = ["Mc", "BC"] //tambahin sendiri kata² nya, gunakan huruf kecil
global.premium = ['918723941586'] //premium user
global.owner = ["8723941586", "918723941586"] //ganti agar fitur owner bisa di gunakan
global.ownernomer = owner[8723941586] + "@s.whatsapp.net"
...
global.author = 'Created By Casse' + ownername //sticker wm ganti nama kalian
...
global.sp = '⭔'
global.mess = {
   sukses: '🤗Done, Successfully ✅~',
   admin: 'This Command only used by admin!',
   botAdmin: 'For excute this command bot need to be admin!',
   owner: 'This command is only used by owner !',
   group: 'This command is for groups only!',
   private: 'Perintah Ini Hanya Bisa Digunaka!',
   bot: 'Fitur Khusus Pengguna Nomor Bot',
   errtoimg: '❌!',
   wait:'Fethcing details 🕒',
